...
from torch._C import Size, device
from torch.autograd.grad_mode import no_grad
from torch.cuda.memory import set_per_process_memory_fraction
import torch.nn.functional as F
from torch.nn import TransformerEncoder, TransformerEncoderLayer
from torch.serialization import check_module_version_greater_or_equal, validate_cuda_device
...
batch_size = 20
eval_batch_size = 10
train_data = batchify(train_data, batch_size) # shape [seq_len, batch-size]
