...
print(all_letters)
print(letterToTensor('Y'))
print(lineToTensor('Yan').size())
...
# Training
def categorFromOutput(output):
    top_n, top_i = output.topk(1)
    category_i = top_i[0].item()
    return all_categories[category_i], category_i

print(categorFromOutput(output))
...
for iter in range(1, n_iters + 1):
    ...
    if iter % print_every == 0:
        guess, guess_i = categorFromOutput(output)
...
# Normalize by dividing ever row by its sum
